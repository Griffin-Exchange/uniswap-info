...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#FF6348' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#FF6348',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#FF6348',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#FF6348',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #FF634830 0%, #fff 0%)`
})
